...
@QuestionProvider(family = "AdditionMultiplication", level = 4)
public class AdditionMultiplicationQuestionProvider implements IQuestionProvider {
	...
	public QuestionContext provide() {
		...
		final Question q = new Question(unid, "What is " + op1 + PLUS + op2 + MULT + op3 + " ?");
