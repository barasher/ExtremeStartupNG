...
public abstract class AbstractFibonnaciQuestionTest {

	private final AbstractFibonnaciQuestionProvider _provider;
	private final Pattern _pattern;

	protected AbstractFibonnaciQuestionTest(AbstractFibonnaciQuestionProvider aProvider) {
		_provider = aProvider;
