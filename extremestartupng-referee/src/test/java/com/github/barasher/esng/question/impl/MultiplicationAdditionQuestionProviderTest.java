...
import com.github.barasher.esng.question.impl.MultiplicationAdditionQuestionProvider;

@RunWith(SpringRunner.class)
public class MultiplicationAdditionQuestionProviderTest {

	private IQuestionProvider _provider = null;
	private final Pattern _pattern;

	public MultiplicationAdditionQuestionProviderTest() {
		_provider = new MultiplicationAdditionQuestionProvider();
		_pattern = Pattern.compile(".* (\\d+)" + MultiplicationAdditionQuestionProvider.MULT + "(\\d+)"
				+ MultiplicationAdditionQuestionProvider.PLUS + "(\\d+) .*");
	}
